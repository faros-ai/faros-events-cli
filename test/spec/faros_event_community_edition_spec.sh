Describe 'faros_event.sh (Community edition)'
  ...
  Describe 'Community edition CD event'
    compute_application='Calling Hasura rest endpoint compute_application with payload { "name": "<application>", "platform": "", "uid": "<application>", "data_origin": "Faros_Script_Event" }'
