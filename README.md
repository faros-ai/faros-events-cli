...
| &#x2011;&#x2011;pull_request_number | The pull request number of the commit. (e.g. `123` or 123). Used only if --commit is included       |                                 |                                                             |
...
| &#x2011;&#x2011;pull_request_number | The pull request number of the commit. (e.g. `123`, 123). Used only if --commit is included       |                                 |                                                             |
