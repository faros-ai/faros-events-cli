...
1. [Download the script manually](https://raw.githubusercontent.com/faros-ai/faros-events-cli/v0.5.0/faros_event.sh) and execute it:
...
```sh
export FAROS_CLI_VERSION="v0.5.0"
...
```sh
docker pull farosai/faros-events-cli:v0.5.0
```

2. Run it:

```sh
docker run farosai/faros-events-cli:v0.5.0 help
```
...
| &#x2011;&#x2011;task_source         | The TMS (Task Management System). (e.g. Jira)                                                                                                            | If &#x2011;&#x2011;defect_task, &#x2011;&#x2011;test_suite_task, or &#x2011;&#x2011;test_execution_task provided |                                                                                  |
