...
$ ./faros_event.sh CI -k "<faros_api_key>" \
    ...
    --commit "<commit_source>://<commit_organization>/<commit_repo>/<commit_sha>" \
...
| ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- | ----------------------------------------------------------- |
| &#x2011;&#x2011;commit             | The URI of the commit. (`<commit_source>://<commit_organization>/<commit_repo>/<commit_sha>` e.g. `GitHub://faros-ai/my-repo/da500aa4f54cbf8f3eb47a1dc2c136715c9197b9`)            | Yes                             |                                                             |
...
| &#x2011;&#x2011;run                | The URI of the job run that built the code. (`<run_source>://<run_organization>/<run_pipeline>/<run_id>` e.g. `Jenkins://faros-ai/my-pipeline/1234`)                               |                                 |                                                             |
...
| Argument                              | Description                                                                                                                                                                              | Required                                                  | Allowed Value                                                  |
| ------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- | -------------------------------------------------------------- |
| &#x2011;&#x2011;deploy                | The URI of the deployment. (`<deploy_source>://<deploy_application>/<deploy_environment>/<deploy_id>` e.g. `ECS://my-app/Prod/1234`)                                                     | Yes                                                       | `deploy_env`: Prod, Staging, QA, Dev, Sandbox, Custom          |
| &#x2011;&#x2011;deploy_status         | The status of the deployment.                                                                                                                                                            | Yes                                                       | Success, Failed, Canceled, Queued, Running, RolledBack, Custom |
| &#x2011;&#x2011;artifact              | The URI of the artifact. (`<artifact_source>://<artifact_organization>/<artifact_repository>/<artifact_id>` e.g. `DockerHub://farosai/my-repo/da500aa4f54cbf8f3eb47a1dc2c136715c9197b9`) | Either &#x2011;&#x2011;commit or &#x2011;&#x2011;artifact |                                                                |
| &#x2011;&#x2011;commit                | The URI of the commit. (`<commit_source>://<commit_organization>/<commit_repository>/<commit_sha>` e.g. `GitHub://faros-ai/my-repo/da500aa4f54cbf8f3eb47a1dc2c136715c9197b9`)            | Either &#x2011;&#x2011;commit or &#x2011;&#x2011;artifact |                                                                |
...
| &#x2011;&#x2011;run                   | The URI of the job run executing the deployment. (`<run_source>://<run_organization>/<run_pipeline>/<run_id>` e.g. `Jenkins://faros-ai/my-pipeline/1234`)                                |                                                           |                                                                |
