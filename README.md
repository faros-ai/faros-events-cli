...
1. [Download the script manually](https://raw.githubusercontent.com/faros-ai/faros-events-cli/v0.3.2/faros_event.sh) and execute it:
...
```sh
$ export FAROS_CLI_VERSION="v0.3.2"
...
```sh
$ docker pull farosai/faros-events-cli:v0.3.2
```

2. Run it:

```sh
$ docker run farosai/faros-events-cli:v0.3.2 help
```
