...
1. [Download the script manually](https://raw.githubusercontent.com/faros-ai/faros-events-cli/v0.4.4/faros_event.sh) and execute it:
...
```sh
export FAROS_CLI_VERSION="v0.4.4"
...
```sh
docker pull farosai/faros-events-cli:v0.4.4
```

2. Run it:

```sh
docker run farosai/faros-events-cli:v0.4.4 help
```
